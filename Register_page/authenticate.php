<?php
    ...
    if(isset($_POST["username"]) && isset($_POST["password"])){
               ...
               // echo "bind param <br>";
                ...
                if(mysqli_stmt_execute($stmt)){
                    ...
                    if(mysqli_stmt_num_rows($stmt) > 1){
                        ...
                        mysqli_stmt_bind_result($stmt, $r_uid, $r_rid,
                                                $r_fullname, $r_pw, 
                                                $r_gender, $r_title);

                        //echo "bind stmt result <br>";
        ...
        // if($good == true){echo "good -- true";}else{"good -- false";}
        // if($validate == true){echo "validate -- true";}else{"validate -- false";}
