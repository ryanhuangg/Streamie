    ...
    <div class="outer">
        <div class="middle">
            <div class="inner">
                    ...
                    <h4> <?php echo "Reference ID: ". $_SESSION['rid'];?> </h2>
                    <h4> <?php echo "Name: ". $_SESSION['fullname'];?> </h2>
                    <h4> <?php echo "uid: ".  $_SESSION['uid'];?> </h2>
                    <h4> <?php echo "title: ".  $_SESSION['title'];?> </h2>
                    <h4> <?php echo "Gender: ".  $_SESSION['gender'];?> </h2>
                    <h4> <?php echo "pw: ".  $_SESSION['pw'];?> </h2>
                    ...
                    <div style="text-align:center;">
                        ...
                        <tr>
                            <th>
                                ...
                                <a href="homepage.php"> <input type="submit" name="back" value="back" />
                                </a>
                            </th>
                        </tr>
...
<?php
    ...
    // if($_SESSION["loggined"] == true || !isset($_SESSION["loggined"])){
    ...
    function change_user_profile($check_rid,$check_uid,$new_password,
		...
		if($stmt = mysqli_prepare($dbconn, $query)){
            ...
            if($flag == false){
                //set new pw
                if($change_pw == true){
                    echo "change pw UP <br>";
                    $q_newpw = $new_password;
                }else{
                    echo "not change pw UP <br>";
                    $q_newpw = $c_pw;
                }

                //set new fullname
                if($change_fullname == true){
                    echo "change fullname UP <br>";
                    $q_fullname = $new_fullname;
                }else{
                    echo "not change fullname UP <br>";
                    $q_fullname = $c_fullname;
                }

                //set new gender
                if($change_gender == true){
                    echo "change gender UP <br>";
                    $q_gender = $new_gender;
                }else{
                    echo "not change gender UP <br>";
                    $q_gender = $c_gender;
                }

                //set new title
                if($change_title == true){
                    echo "change title UP <br>";
                    $q_title = $new_title;
                }else{
                    echo "not change title UP <br>";
                    $q_title = $c_title;
                }
            ...
            if($flag == true){
                if(mysqli_stmt_execute($stmt)){
                    ...
                    if(mysqli_stmt_affected_rows($stmt) > 0){
                        ...
                        echo "<br> excute change new UP sucess <br>";
                        return true;

                    }else{
                        echo "<br> excute change new UP failed <br>";
                        return false;
                    }
                }else{
    ...
    echo "<br> check is isset session <br>";

    //if(isset($_POST['update']) && isset($_SESSION["uid"]) && isset($_SESSION['rid'])){
    if(isset($_POST['update'])){
        echo " <br> checked is isset session <br>";
